...
export const ContainerScroll = ({
  ...
  return (
    <div
      className="h-[60rem] -top-28 md:h-[80rem] flex justify-center relative p-2 md:p-20"
      ref={containerRef}
    >
      <div
...
export const Card = ({
  ...
  return (
    <motion.div
      ...
      className="-mt-12 mx-auto h-[30rem] md:h-[40rem] w-full border-[#6C6C6C] bg-[#222222] rounded-[30px] shadow-2xl"
    >
