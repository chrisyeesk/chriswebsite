          ...
          <div className="grid px-4 lg:px-4 grid-cols-1 lg:grid-cols-3 gap-4 2xl:max-w-[1500px] lg:max-w-[1120px] mx-auto w-full">
            ...
            >
              <div className="2xl:p-10 max-w-xs 2xl:max-w-4xl">
                <h2 className="2xl:mb-10  text-left 2xl:text-4xl text-balance text-base md:text-xl lg:text-3xl font-semibold tracking-[-0.015em] text-white">
                  <LinkPreview
              ...
              <Image
                ...
                className="absolute 2xl:w-[1000px] 2xl:-bottom-80  -right-14 md:-right-[29%] lg:-right-[15x%] md:-bottom-32 grayscale filter mt-3 lg:-bottom-24 object-contain rounded-2xl"
              />
            </WobbleCard>
            <WobbleCard containerClassName="bg-[#10172A] col-span-1 min-h-[300px]">
              <div className="2xl:p-10">
                <h2 className="max-w-80 2xl:mb-10 2xl:text-4xl text-left text-balance text-base md:text-xl lg:text-3xl font-semibold tracking-[-0.015em] text-white">
            ...
            <WobbleCard containerClassName="2xl:min-h-[700px] col-span-1 lg:col-span-3 bg-[#10172A]  min-h-[500px] md:min-h-[400px] lg:min-h-[300px] xl:min-h-[300px]">
              <div className="2xl:p-10 2xl:max-w-4xl max-w-sm">
                <h2 className="2xl:mb-10 max-w-sm 2xl:text-4xl md:max-w-lg 2xl:max-w-4xl text-left text-balance text-base md:text-xl lg:text-3xl font-semibold tracking-[-0.015em] text-white">
                  Final Year Software Project
                </h2>
                <p className="mt-4 2xl:text-2xl max-w-[26rem] 2xl:w-[73rem] 2xl:max-w-[150rem] text-left  text-base/6 text-neutral-200">
